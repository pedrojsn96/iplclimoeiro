...
import { Button, Navbar, MegaMenu, Dropdown, Avatar } from "flowbite-react";
...
const Header: React.FunctionComponent = () => {
  ...
  return (
      ...
      <Navbar.Collapse>
        ...
        <li>
          <Dropdown
            arrowIcon={true}
            inline
            label="Servo de Deus Luís Cecchin"
          >
            <Dropdown.Item>Dashboard</Dropdown.Item>
            <Dropdown.Item>Settings</Dropdown.Item>
          </Dropdown>
        ...
        <li style={{ cursor: 'pointer' }}>Parceiros</li>
        <li>
          <Dropdown
            arrowIcon={true}
            inline
        ...
        <li style={{ cursor: 'pointer' }}>Contato</li>
      </Navbar.Collapse>
    </Navbar>
    // <MegaMenu>
    ...
    //               <li style={{ cursor: 'pointer' }} className='font-rubikRegular hover:text-iplc'><a href='/my-vite-app/sobre-nos'>sobre nos</a></li>
    //               <li style={{ cursor: 'pointer' }} className='font-rubikRegular hover:text-iplc'><a href='/my-vite-app/sobre-nos'>sobre nos</a></li>
    //               <li style={{ cursor: 'pointer' }} className='font-rubikRegular hover:text-iplc'><a href='/my-vite-app/sobre-nos'>sobre nos</a></li>
