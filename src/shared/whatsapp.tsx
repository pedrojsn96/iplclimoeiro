...
const WhatsApp: React.FunctionComponent = () => {
  ...
  return (
    <div className="flex flex-wrap"> 
        <a style={floatStyle} href='https://wa.me/+5581985304323?text=Ol%C3%A1%20IPLC%2C%20quero%20fazer%20parte%20dessa%20transforma%C3%A7%C3%A3o!' target='_blank' onClick={handleWhatsApp}>
