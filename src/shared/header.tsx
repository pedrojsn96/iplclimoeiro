          ...
          <MegaMenu.Dropdown toggle={
            ...
            <ul className="grid grid-cols-1">
              <div className="space-y-4 p-4">
                ...
                <li><Navbar.Link style={{ cursor: 'pointer' }} onClick={() => navigate(ROUTER_PATHS.ATIVIDADES_SOCIOFAMILIAR)} className='font-rubikRegular hover:text-iplc'>Formação Geral para o Mundo do Trabalho</Navbar.Link></li>
                <li><Navbar.Link style={{ cursor: 'pointer' }} onClick={() => navigate(ROUTER_PATHS.ATIVIDADES_FORMACAO)} className='font-rubikRegular hover:text-iplc'>Serviço de Convivência e Fortalecimento de Vínculos</Navbar.Link></li>
