        ...
        <div className="max-w-screen-xl px-4 py-8 mx-auto space-y-12 lg:space-y-8 lg:py-24 lg:px-6">
            ...
            <div className="gap-8 lg:grid lg:grid-cols-1 xl:gap-16">
                <div className="text-gray-500 sm:text-lg">
                    ...
                    <p className="font-rubikLight mb-4 font-light lg:text-xl text-justify">Contudo, o Instituto Padre Luís Cecchin continua levando adiante o legado deixado por seu fundador, em prestar assistência a família como um todo, desde a fase inicial até a fase adulta, acolhendo a todos como filhos e filhas de um único Pai misericordioso, interferindo nas estruturas sociais para o exercício pleno da cidadania buscando promover <b className='text-gray-800'>“Caminhos de oportunidades para um novo amanhã.”</b></p>
                </div>
            </div>
          </div>
      </section>
