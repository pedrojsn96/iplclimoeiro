        ...
        <div className="max-w-screen-xl px-4 py-1 mx-auto space-y-1">
            ...
            <div className="gap-1 lg:grid lg:grid-cols-1">
                <div className="text-gray-500 sm:text-lg">
                    ...
                    <p className="font-rubikLight mb-8 font-light lg:text-xl text-justify">Doações de vestuário, calçados, brinquedos, entre outros para o público vulnerável.</p>
                </div>
            </div>
            {/* <!-- Row --> */}
            <div className="gap-1 lg:grid lg:grid-cols-1">
                <div className="text-gray-500 sm:text-lg">
                    ...
                    <p className="font-rubikLight mb-8 font-light lg:text-xl text-justify">Realização de um café da manhã aberto a todos que chegarem ao Projeto caridade e distribuição de pães para o complemento da refeição familiar.</p>
                </div>
            </div>
            {/* <!-- Row --> */}
            <div className="gap-1 lg:grid lg:grid-cols-1">
                <div className="text-gray-500 sm:text-lg">
                    ...
                    <p className="font-rubikLight mb-8 font-light lg:text-xl text-justify"> Para o atendimento das necessidades de famílias de maior necessidade alimentar previamente acompanhadas pela assistente social são cadastradas para receber a doação da sopa.</p>
                </div>
            </div>
            {/* <!-- Row --> */}
            <div className="gap-1 lg:grid lg:grid-cols-1">
                <div className="text-gray-500 sm:text-lg">
                    ...
                    <p className="font-rubikLight mb-8 font-light lg:text-xl text-justify">atividade de acolhida, escuta e aconselhamento para o público vulnerável que apresenta interesse e necessidade.</p>
                </div>
            </div>
          </div>
      </section>
