...
Promovendo oficinas de: Formação humano/Cristã, Inclusão Digital, Educação Ambiental, Oficina Esportiva, Oficina de Música, Oficina de Horticultura, Oficina de Artes, Língua Estrangeira (Inglês), Capoeira, biblioteca e diariamente refeições nutritivas.</p>
            ...
            <div className="gap-1 lg:grid lg:grid-cols-1">
                <div className="text-gray-500 sm:text-lg">
                    ...
                    <p className="font-rubikLight mb-4 font-light lg:text-xl text-justify">Em conformidade com as diretrizes das Políticas Públicas de Educação, a Prefeitura Municipal de Limoeiro através do ACORDO DE COOPERAÇÃO oportuniza 257 atendimentos para a faixa etária dos 06 meses aos 4 anos e 11 meses nos Centros Municipais de Educação Infantil Padre Luís Cecchin e Sagrada Família.</p>
                </div>
                <div className="flex justify-center">
